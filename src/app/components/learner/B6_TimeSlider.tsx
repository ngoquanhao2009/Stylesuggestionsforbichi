...
const B6_TimeSlider: React.FC<TimeSliderProps> = ({ currentYear, onYearChange, disabled }) => {
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="relative pt-8 pb-4">
        ...
        {/* Progress track */}
        <motion.div
          className="absolute top-12 left-0 h-1 bg-gradient-to-r from-yellow-400 via-emerald-400 to-blue-400 rounded-full"
          initial={{ width: 0 }}
        ...
        <input
          ...
          disabled={disabled}
          className="absolute top-12 left-0 right-0 w-full h-1 opacity-0 cursor-pointer appearance-none"
